 ...
 * @author Grupo 2
 */
public final class Hierbas extends javax.swing.JFrame {
    ...
    public Hierbas() {
        ...
        TablaHierbas.setModel(conexion.EscojerProductos("Hierbas"));
        seleccionarPersona();
    }

    public void seleccionarPersona() {
        TablaHierbas.addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent Mouse_evt) {
                if (Mouse_evt.getClickCount() == 1) {
                    confirmar = true;
                    Reporte_Proveedores proveedor = new Reporte_Proveedores();
                    txtCodigo.setText(TablaHierbas.getValueAt(TablaHierbas.getSelectedRow(), 0).toString());
                    dato = (int) TablaHierbas.getValueAt(TablaHierbas.getSelectedRow(), 2);
                    spCantidad.setModel(new javax.swing.SpinnerNumberModel(1, 0, dato, 1));
                    lblCodigo.setText(TablaHierbas.getValueAt(TablaHierbas.getSelectedRow(), 4).toString());
    ...
    private void initComponents() {
        ...
        TablaHierbas = new javax.swing.JTable();
        ...
        TablaHierbas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        if (confirmar == true) {
            ...
            if (seleccion == 0) {
                carrito.Ingresar(lblCodigo.getText(),
                        TablaHierbas.getValueAt(TablaHierbas.getSelectedRow(), 0).toString(),
                        TablaHierbas.getValueAt(TablaHierbas.getSelectedRow(), 1).toString(),
                        lblTitulo.getText(),
                        Integer.parseInt(spCantidad.getValue().toString()),
                        Double.parseDouble(TablaHierbas.getValueAt(TablaHierbas.getSelectedRow(), 3).toString()));
            }
    ...
    private javax.swing.JTable TablaHierbas;
