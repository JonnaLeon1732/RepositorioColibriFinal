 ...
 * @author Grupo 2
 */
public final class Lacteos extends javax.swing.JFrame {
    ...
    public Lacteos() {
        ...
        TablaLacteos.setModel(conexion.EscojerProductos("Lacteos"));
        seleccionarPersona();
    }

    public void seleccionarPersona() {
        TablaLacteos.addMouseListener(new MouseAdapter() {
            @Override
            public void mousePressed(MouseEvent Mouse_evt) {
                if (Mouse_evt.getClickCount() == 1) {
                    confirmar = true;
                    Reporte_Proveedores proveedor = new Reporte_Proveedores();
                    txtCodigo.setText(TablaLacteos.getValueAt(TablaLacteos.getSelectedRow(), 0).toString());
                    dato = (int) TablaLacteos.getValueAt(TablaLacteos.getSelectedRow(), 2);
                    spCantidad.setModel(new javax.swing.SpinnerNumberModel(1, 0, dato, 1));
                    lblCodigo.setText(TablaLacteos.getValueAt(TablaLacteos.getSelectedRow(), 4).toString());
        ...
        if (confirmar == true) {
            ...
            if (seleccion == 0) {
                carrito.Ingresar(lblCodigo.getText(),
                        TablaLacteos.getValueAt(TablaLacteos.getSelectedRow(), 0).toString(),
                        TablaLacteos.getValueAt(TablaLacteos.getSelectedRow(), 1).toString(),
                        lblTitulo.getText(),
                        Integer.parseInt(spCantidad.getValue().toString()),
                        Double.parseDouble(TablaLacteos.getValueAt(TablaLacteos.getSelectedRow(), 3).toString()));
            }
