...
import static principales_gui.Verduras.confirmar;
        ...
        TablaFrutas.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent Mouse_evt) {
                if (Mouse_evt.getClickCount() == 1) {
                    ...
                    lblCodigo.setText(TablaFrutas.getValueAt(TablaFrutas.getSelectedRow(), 4).toString());
        ...
        if (confirmar == true) {
            ...
            if (seleccion == 0) {
                carrito.Ingresar(lblCodigo.getText(),
                        TablaFrutas.getValueAt(TablaFrutas.getSelectedRow(), 0).toString(),
                        TablaFrutas.getValueAt(TablaFrutas.getSelectedRow(), 1).toString(),
                        lblTitulo.getText(),
                        Integer.parseInt(spCantidad.getValue().toString()),
                        Double.parseDouble(TablaFrutas.getValueAt(TablaFrutas.getSelectedRow(), 3).toString()));
            }
